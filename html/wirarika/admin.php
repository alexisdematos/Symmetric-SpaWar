    ...
    <div class="culmn">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a href="#validation">VALIDATION SECTION</a></li>                                                
      ...
      <div class="fullpage">
        ...
        <div class="ab-center">
          ...
          <p>Administration room<br>Thank you for sharing your knowledge.<br>
          </p>
          </div>
        </div>
        </div>
...
<!-- Validation section -->
    <div class="portfolio" id="validation" >
      <div class="spacer">
        <div class="container">
        <h2 class="text-center">Validation Section</h2>
...
while($i <= $nb_ligne_fichier){?>
	 <form id="test<?php echo $i;?>" action="admin.php#validation" method="post">
				<input type="hidden" name="a_recup" value="<?php echo $i;?>" style="height:0;"/>
			</form>
			<form id="test2<?php echo $i;?>" action="admin.php#validation" method="post">
...
echo '<td id="middle">'.$ligne1[1].'</td>'; // piece2
	?>
			...
			<ul class="dropdown-menu" id="backgroundwhite" role="menu">
				...
				<li><a href="#" onclick="document.getElementById('test<?php echo $i;?>').submit();">Add</a></li>
				<li class="divider"></li>
				<li><a href="#" onclick="document.getElementById('test2<?php echo $i;?>').submit();">Delete</a></li>
			<?php echo'</ul>
</div>
	  </td>';
	}
